...
const StatCard = ({ title, primaryIcon, details, dateRange }: StatProps) => {
  ...
  return (
    <div className="md:row-span-1 xl:row-span-2 bg-white col-span-1 shadow-md rounded-2xl flex flex-col justify-between">
      {/* HEADER */}
      <div className="">
        <div className="flex justify-between items-center mb-2 px-5 pt-5">
      ...
      {/* BODY */}
      <div className="flex mb-6 items-center justify-around gap-5 px-5">
